	...
	export default {
		...
		methods: {
			...
			//	document.head.appendChild(script);
				...
				//	</view>
				//</template>
				//plus.runtime.openURL('http://192.168.181.246/1/hot.html');//手机端成功
				//window.opener = null;
				//window.location.href ='http://192.168.181.246/1/hot.html';
				//window.open('http://192.168.181.246/1/hot.html');     //H5成功
				//this.$router.back()  
				//window.history.go(-2)
				...
				//window.open('http://192.168.181.246/1/hot.html');     //H5成功
				let parmas = {"appid":"422773824723924476","appkey":"72dfe9623c3fca30584e27092ed76a02"}  //个人
				let thinkData = new EventReport("http://192.168.181.252:8091", parmas["appid"], parmas["appkey"], 0)
				thinkData.track("热榜",{url_path:decodeURI(window.location.pathname)})
